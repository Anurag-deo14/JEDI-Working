...
public class FlipFitGymOwnerDAO implements FlipFitGymOwnerDAOInterface {
    ...
    public boolean loginGymOwner(String username, String password) {
        try {
            conn = DatabaseConnector.connect(); // Ensure this method throws SQLException if needed
            ResultSet result;
            try {
            ...
            } catch (SQLException e) { // Catch SQL-specific issues
                System.out.println("SQL Exception: " + e.getMessage());
            }
        } catch (Exception e) { // General exception catch (optional)
